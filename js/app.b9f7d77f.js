(function(e) {
	...
	"56d7": function(e, t, a) {
		...
		f.beforeEach((function(e, t, a) {
			document.title = v ? v.t(e.meta.title) + " - " + v.t("bigdataTitle") : "大数据分析实践", null === f.resolve(e)
				.resolved.name && a("/"), a()
		}));
		var y = a("2f62");
		n["default"].use(y["a"]);
