(function(e) {
	function t(t) {
		for (var i, n, r = t[0], l = t[1], h = t[2], c = 0, d = []; c < r.length; c++) n = r[c], Object.prototype.hasOwnProperty.call(s, n) && s[n] && d.push(s[n][0]), s[n] = 0;
	...
	l.e = function(e) {
		...
		n[e] ? t.push(n[e]) : 0 !== n[e] && a[e] && t.push(n[e] = new Promise((function(t, a) {
				...
				for (r = 0; r < d.length; r++) {
					h = d[r], c = h.getAttribute("data-href");
					if (c === i || c === s) return t()
				}
				...
				u.rel = "stylesheet", u.type = "text/css", u.onload = t, u.onerror = function(t) {
					...
					o.code = "CSS_CHUNK_LOAD_FAILED", o.request = i, delete n[e], u.parentNode.removeChild(u), a(o)
				}, u.href = s;
				...
				h = function(t) {
					...
					if (0 !== a) {
						if (a) {
							...
							d.message = "Loading chunk " + e + " failed.\n(" + i + ": " + n + ")", d.name = "ChunkLoadError", d.type = i, d.request = n, a[1](d)
						}
						s[e] = void 0
					}
				};
	...
	var h = window["webpackJsonp"] = window["webpackJsonp"] || [],
		c = h.push.bind(h);
	h.push = t, h = h.slice();
	for (var d = 0; d < h.length; d++) t(h[d]);
	var u = c;
	...
	3504: function(e) {
		e.exports = JSON.parse('{"bigdataTitle":"可视化技术","homePage":"课程首页","projectList":"课题列表","resultList":"成果展示","courseResources":"课程资源","courseEntries":"课程入口","courseEntriesHint":"（仅限选课学生进入）","location":"山东大学・青岛","courseDesc":"课程描述","courseDescContent":"可视化将看不见的数据转变为直观的图形，能够帮助人们理解数据背后隐藏的规律，是数据分析的有力手段。该课程涵盖了包括信息可视化和科学可视化在内的许多可视化子领域的主题，旨在向学生展示数据可视化如何在各个领域的数据分析过程中寻找实际问题的解决方案。通过这门课程，学生们将会熟悉一些展示不同类型数据的可视化技术和方法，并培养在遇到实际的问题的时候能够迅速利用基于可视化的方法对问题做出回应的能力。","aims":"教学目标","aims1":"通过本课程的学习，学生具备扎实的可视化理论基础和实践能力，通过可视化课程设计等教学环节，整合软件工程和Web程序设计等相关课程的知识，最终使得学生具备利用软件工程手段解决实际的可视化问题的初步能力。","aims2":"通过可视化理论及常用工具的授课，培养学生可视化图表的设计能力，使得学生具备在日常工作中承担可视化设计工作的能力。可视化技术发展迅速，通过在教学内容中增加可视化技术的前沿研究内容，培养学生的研究兴趣和研究能力。","aims3":"通过本课程的实验和课程设计，学生通过各种工具实现可视化效果，培养学生掌握和使用现代工具的能力。汇报、报告撰写等，培养学生的沟通能力，使得学生能够快速获取新知识和新信息。","request":"教学要求","requestContent":"本课程旨在为学生提供理解当前可视化研究进展所需的基础知识。课程结束时,学生将获得:","requestContent1":"了解关键可视化技术和理论,包括数据模型、图形感知和视觉编码和交互的方法。","requestContent2":"接触一些常见的数据域和相应的分析任务,包括多元数据、网络、文本和制图。","requestContent3":"构建和评估可视化系统。","requestContent4":"能够阅读和讨论可视化论文。","reference":"教材及参考资料","authors":"编著者","pub":"出版社","pubYear":"出版年","ptPress":"人民邮电出版社","phei":"电子工业出版社","noResult":"暂无成果信息","fetching":"正在获取文件列表…","fileName":"文件名","url":"地址","teacherAndTA":"授课教师与助教信息","LOT":"教学大纲","week":"周次","date":"日期","topic":"主题","grading":"评分细则","task":"个人任务","paperPres":"期中文献阅读与展示","paperPresDesc":"选择与你所选项目最相关的参考论文进行阅读与展示","finalProject":"期末项目","paperWriting":"书面报告","pages":"页正文","referencePage":"页参考文献","presentation":"项目展示","oral":"汇报质量","codeQuality":"代码质量","midTerm":"中期检查","attend":"课堂参与程度","attendency":"签到情况","disscuss":"讨论与作业","disscussDesc":"包含课上讨论与课下作业完成情况（3项个人作业以及5项小组作业）","peer":"组间评价","bouns":"各小组组长将获得5%的额外加分"}')
	},
	"38a8": function(e, t, a) {
		"use strict";
		a.r(t);
	...
	"47f5": function(e, t, a) {
		...
		var i = function() {
			...
			n = [function() {
				var e = this,
					t = e._self._c;
				return t("section", [t("h1", [e._v("Poetry Visualization")]), t("h2", [e._v("方博文 宋家庆 苗琳瑜 张一凡 吴祥钧")]), t("p", [e._v("Ancient poetry is a special style in Chinese literature, which carries the splendid culture of Chinese civilization with a long history and endless life, it is a perfect fusion carrier of philosophy and aesthetics, and is the treasure of Chinese traditional culture and the essence of traditional spirit. Learning and mastering the knowledge of ancient Chinese poetry and analyzing the connections between them is a good way to understand the development of Chinese civilization and even human civilization. In order to explore the hidden information in ancient poetry, we start from the essence of ancient poetry, analyze the data of ancient poetry from four aspects: time, geography, emotion and category, and make a poetry visualization system. However, the traditional data analysis methods are often ineffective when applied directly to the ancient poetry dataset, and we modify the ancient poetry dataset according to local conditions for the two tasks of text clustering and sentiment analysis. At the same time, in terms of visualization, we combine visual form with the traditional Chinese art style, so that poetry data can better convey the hidden historical information.")]), t("p", [e._v("Ancient poetry is the essence of traditional Chinese culture and occupies\nan important position in the splendid ancient culture of China. They are not\nonly rich in connotation, all-embracing and profound in meaning, with high\naesthetic value and strong artistic influence, but also have concise language,\nshort and concise, beautiful words and rhymes, which make them unique in the\nChinese literary world. Therefore, we analyze and visualize the data of ancient\npoems from four perspectives of emotion, category, time and geography, taking\ninto account the following factors.")]), t("ul", [t("li", [t("p", [e._v("Poets write poems to express their thoughts, ambitions, and aspirations.")])]), t("li", [t("p", [e._v("The themes of poetry can often be classified as a border, garden, farewell,\netc. The techniques or intentions used in different categories of poetry are\nvery different.")])]), t("li", [t("p", [e._v("In the long history, poems often reflect the changes of a dynasty or era, and\nthe policies of a dynasty can greatly influence the enthusiasm for poetry.")])]), t("li", [t("p", [e._v("There are many famous places in China, and poets in ancient times often\ntraveled to the mountains and rivers, using them to express their emotions,\nand different places are often rich in different historical heritage.")]), t("p", [e._v("In addition to the above tasks, we also implemented three tasks: similar poetry\nsearch, poetry continuation, and generation of hidden poems, in order to enrich\ninteractivity and add further insight into the mysteries of ancien")])])])])
			}],
			s = {
				components: {}
			},
	...
	"56d7": function(e, t, a) {
		...
		var i = a("ade3"),
			...
			r = function() {
				...
				return t("div", {
					...
					attrs: {
						href: "https://github.com/sduVisualizationcourse"
					}
				}, [t("Icon", {
					attrs: {
						type: "logo-github"
		...
		f.beforeEach((function(e, t, a) {
			document.title = v ? v.t(e.meta.title) + " - " + v.t("bigdataTitle") : "可视化技术", null === f.resolve(e)
				.resolved.name && a("/"), a()
		}));
		var y = a("2f62");
		n["default"].use(y["a"]);
			...
			w = new y["a"].Store({
				state: {
					...
					classrooms: [{
						...
						repos: [{
							name: "1015课堂讨论",
							enName: "final project - 23/12/2023",
							markdown: _("23projects")
						}]
					}],
					references: [{
						id: 0,
		...
		function I(e) {
			for (var t = 1; t < arguments.length; t++) {
				...
				t % 2 ? z(Object(a), !0)
					.forEach((function(t) {
						Object(i["a"])(e, t, a[t])
					})) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(a)) : z(Object(a))
					.forEach((function(t) {
